...
var AWS_TEMPLATE = "iam.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "iam.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "iam.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "iam.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "iam.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "iam" }, regionInfo));
};
