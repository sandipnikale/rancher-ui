 ...
 *
 */
var AddClientIDToOpenIDConnectProviderCommand = /** @class */ (function (_super) {
    __extends(AddClientIDToOpenIDConnectProviderCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AddClientIDToOpenIDConnectProviderCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AddClientIDToOpenIDConnectProviderCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IAMClient";
        var commandName = "AddClientIDToOpenIDConnectProviderCommand";
    ...
    AddClientIDToOpenIDConnectProviderCommand.prototype.serialize = function (input, context) {
        return serializeAws_queryAddClientIDToOpenIDConnectProviderCommand(input, context);
    };
    AddClientIDToOpenIDConnectProviderCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_queryAddClientIDToOpenIDConnectProviderCommand(output, context);
    };
    return AddClientIDToOpenIDConnectProviderCommand;
}($Command));
export { AddClientIDToOpenIDConnectProviderCommand };
