...
class UntagSAMLProviderCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UntagSAMLProviderRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_query_1.serializeAws_queryUntagSAMLProviderCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_query_1.deserializeAws_queryUntagSAMLProviderCommand(output, context);
    }
}
