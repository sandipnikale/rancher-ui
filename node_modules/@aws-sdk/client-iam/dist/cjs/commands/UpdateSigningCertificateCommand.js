...
class UpdateSigningCertificateCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return Aws_query_1.serializeAws_queryUpdateSigningCertificateCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_query_1.deserializeAws_queryUpdateSigningCertificateCommand(output, context);
    }
}
