    ...
    switch (region) {
        ...
        default:
            ...
            if (AWS_ISO_REGIONS.has(region)) {
                return exports.defaultRegionInfoProvider("aws-iso-global");
            }
            if (AWS_ISO_B_REGIONS.has(region)) {
                return exports.defaultRegionInfoProvider("aws-iso-b-global");
            }
            if (AWS_US_GOV_REGIONS.has(region)) {
                return exports.defaultRegionInfoProvider("aws-us-gov-global");
            }
